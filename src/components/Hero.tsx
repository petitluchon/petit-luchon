...
export default function Hero() {
  const { data, loading } = useSanityData<HeroData>(queries.hero);
  ...
  const heroData = data || {
    title: 'Bienvenue au Petit Luchon',
    subtitle: 'Cuisine chinoise authentique et chaleureuse au cœur de Marseille',
    tagline: 'Produits frais • Recettes maison • Accueil familial',
    chineseCharacter: '福',
  ...
  const bgImage = heroData.backgroundImage 
    ...
    : 'https://lh3.googleusercontent.com/pw/AP1GczMKoeeFTwIii9xJVfByjASKqGC_y7FYj8t9btPDA29ZNAEV7WkXS9tQ4RLSc_7wg00xsKfrz6KQYJEaOyUVEn97BfYbWKnsCRNh4sqmchXOGGmdXx2T_eQ2_1z_Q5L4GQFotmbe-sNghg4HwyyZfJM=w1438-h958-s-no-gm?authuser=0';
